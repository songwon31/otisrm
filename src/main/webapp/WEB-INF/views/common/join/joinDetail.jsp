...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
 	...
 	<table style="border-collapse:collapse;">
         <tbody>
         	<tr>
         		<td>
         			<div class="mt-4 ml-4"> ■ 본 시스템은 회원에게만 제공되는 서비스로 회원가입을 통해 신청자에 관한 개인정보를 일부 수집∙이용하고 있습니다.</div>
			<div class="mt-4 ml-4">■ 개인정보 처리에 대한 상세한 사항은 홈페이지(https://www.otisrm.com/)에 공개한 '개인정보 처리방침'을 참조하십시오.</div>
			<div class="ml-4">다만, 본 동의서 내용과 상충되는 부분은 본 동의서의 내용이 우선합니다.</div>
         		</td>
         	</tr>            	      	
         <tr>
         	<td>	
         		<br>
			<div class="mt-4 ml-4">개인정보 수집∙이용 내역(필수)</div><br>
				<div class="ml-4">
