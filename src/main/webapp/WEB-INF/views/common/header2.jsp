...
<html>
   <head>
      ...
      <!-- javascript 코드 -->
      <script src="${pageContext.request.contextPath}/resources/javascript/common/header2.js"></script>
      
      <!-- css 코드 -->
      <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/common/header2.css"/>
	...
	<div id="bodyDiv">
    	...
    	<div id="background">
        	<div style="display:flex; flex-direction:row;">
				...
				--%>
                <%@ include file="/WEB-INF/views/common/menu2.jsp" %>
