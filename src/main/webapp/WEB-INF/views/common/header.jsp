   	...
   	<nav class="navbar navbar-expand navbar-light topbar static-top shadow">
	    ...
	    <ul class="navbar-nav ml-auto">
	        ...
	        <li class="nav-item dropdown no-arrow mx-1">
	            <a class="nav-link dropdown-toggle" style="color: #f2f3f5; padding-right: 80px;" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
